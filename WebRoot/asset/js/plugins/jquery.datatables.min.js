...
oPaginate:{sFirst:"第一页",sLast:"最后一页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"无有效数据",sInfo:"显示第 _START_ 条到第 _END_ 条记录，共 _TOTAL_ 条记录",sInfoEmpty:"显示第 0 条到第 0 条记录，共 0 条记录",sInfoFiltered:"(从 _MAX_ 条记录中过滤)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"每页显示 _MENU_ 条记录",sLoadingRecords:"加载中...",sProcessing:"处理中...",sSearch:"查找记录:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有匹配记录"},oSearch:h.extend({},
