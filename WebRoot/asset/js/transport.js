...
function appndCheckItem(pid){
    ...
    var appendStr = '<tr>'
        ...
        + '<td><input onkeyup="value=value.replace(/[^\\d]/g,\'\')" name="trItem['+count+'].number" type="text" class="form-control input-sm android" value="" required></td>'
        + '<td><input onkeyup="value=value.replace(/[^\\d.]/g,\'\')" name="trItem['+count+'].cost" type="text" class="form-control input-sm android" value="" required></td>'
        + '<td>'
